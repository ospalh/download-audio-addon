...
EXCLUSION_TAGS = ['nodownload', 'justKana', 'Japanese_Reading']
# EXCLUSION_TAGS = ['nodownload']
# EXCLUSION_TAGS = []

## Automatically try to create cards with this card template/model
## after a download. Standard behaviour: don’t create any, use empty
## list []. Use this when you use cards (Models) that make sense only
## with audio. (That is, that basically contain only the audio.)
# NewCardsToCreate = []
NewCardsToCreate = ['Speak']

# noDownloadMessageFile = u'not_downloading.ogg'
noDownloadMessageFile = u'not_downloading.flac'
...
BlacklistHashes = [
    '29e98c26e204407bdf0d06d91dbe1d5826e173ff4439132258c6b99df6f9d68f',
    '2cedbeb2aca200e637ade41f734fcdd16b4629b4c938fa81f17704c9d8840056',
    '4d50df35c5d64a8a0ad7dac7dd77956f78691a19f474cca533d32a7978140d7c',
    'a3f1f2922c1a354c3f753269b275cf6067ec36d08be2a3685fbb8da10201f5e8',
    'ae6398b5a27bc8c0a771df6c907ade794be15518174773c58c7c7ddd17098906',
    'b0d95809b2352aba3734ae888d625428d659e8d3761bca38b8418cc463986b74',
    'd0d2b2f87359f5754bce72e1d7303a901b2d594e6e95cb06aea91987dd70810a',
    'db6ffc2d484cefffb1a2f2eb78ee09153bf060e18da4f4c86e60fa7b38f6a019',
    'fa9d06dfdaac5736a4cbbdbe496589a4048b8399bc6bc683710168343dd895fc'
    ]

### Uncomment exactly one of the processScriptFileBasename lines:
## Standard behaviour: do not process the downloaded file.:
#processScriptFileBasename = u''
## The two 'real' scripts will only work when a csh is at /bin/csh
## and, lame and sox are installed. That may be the case on a POSIX
## system, but is usually not true on other systems. You're on your
## own. 
#processScriptFileBasename = u'normalise_file_to_wav.csh'
## Try to automatically normalise the files, remove silence at the
## beginning and end and leave it as .wavs:
# processScriptFileBasename = u'normalise_file_to_wav.csh'
## The same, but the output is kept as flacs:
processScriptFileBasename = u'normalise_file_to_flac.csh'
...
## sha256 hashes of all files that aren't caught by the existing
## blacklist are stored in this file in this directory
## ('plugins/Japanese_audio'). It can be used to add hashes to the
## blacklist, especially if the file has already been processed.
hashStoreFileBasename = u'downloaded_files'
